...
void ResponseCurveComponent::timerCallback()
{
    if (parametersChanged.compareAndSetBool(false, true))
    {
        ...
        // This is to re render the curve graph
        repaint();
    }
}
...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    g.setColour(juce::Colour(22u, 22u, 22u));
...
void ResponseCurveComponent::resized()
{
    ...
    for (auto gDb : gain) {
        ...
        g.setColour(gDb == 0.f ? Colour(255u, 0u, 0u) : Colours::dimgrey);
    ...
    for (auto gDb : gain) {
        ...
        g.setColour(gDb == 0.f ? Colour(255u, 0u, 0u) : Colours::lightgrey);
        g.drawFittedText(str, r, juce::Justification::centred, 1);
    }
}
...
{
    // These below are the labels of the sliders
